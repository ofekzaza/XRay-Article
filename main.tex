...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{film_nonlinear_behaviour.png}
    \caption{Film color change relative to exposure}
\end{figure}

Moreover, film color intensity is nonlinear which caused our intensity data to be not linear.
